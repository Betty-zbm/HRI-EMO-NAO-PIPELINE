#!/usr/bin/env python3
"""Evaluate the MELD 4-class WavLM+BERT checkpoint on the held-out MELD test split."""
import sys
...
CKPT = "runs/meld_4cls_wavlm_bert/best_fusion_seq_decoder.pt"
...
merge_labels = args.get("merge_labels", "")
if merge_labels:
    remap = {}
...
exclude_labels = args.get("exclude_labels", "")
if exclude_labels:
